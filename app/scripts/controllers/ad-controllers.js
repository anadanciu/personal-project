...
(function(Controllers, undefined) {
    ...
    adapp.controller("MenusCtrl", ["$scope", "$log", "LanguageService", "Scopes",
        function MenusCtrl($scope, $log, LanguageService, Scopes) {
            ...
            // the pages wrapper
            let stack = document.querySelector('.pages-stack');
            // the page elements
            let pages = [].slice.call(stack.children);
            // total number of page elements
            let pagesTotal = pages.length;
            // index of current page
            let current = 0;
            // menu button
            let menuCtrl = document.querySelector('button.menu-button');
            // the navigation wrapper
            let nav = document.querySelector('.pages-nav');
            // the menu nav items
            let navItems = [].slice.call(nav.querySelectorAll('.link--page'));
